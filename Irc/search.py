...
class GoogleSearch(object):
    SEARCH_URL_0 = "http://www.google.co.uk/search?q=%(query)s"
    NEXT_PAGE_0 = "http://www.google.co.uk/search?q=%(query)s&start=%(start)d"
    SEARCH_URL_1 = "http://www.google.co.uk/search?q=%(query)s&num=%(num)d"
    NEXT_PAGE_1 = "http://www.google.co.uk/search?q=%(query)s&num=%(num)d&start=%(start)d"
